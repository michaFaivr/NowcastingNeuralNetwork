...
%# 20150325 add condition
if numel(SRASTAspot)>2
...
if applyUnif==1   
    print('-dpng', '-r1000', ['RastaMTSATscan' sprintf('%02i',Frank) 'MT' sprintf('%02i',MTnum) '-' sprintf('%i',cloudythresh) 'g' ...
                              sprintf('%02i',NBcla) 'cl' Nettype PredicPixels trainingfct Part sprintf('%02i',RADSneighbor) 'km' dupstring ...
                              'filter' filterIWPflag DIVIDER sprintf('%i',round(divid*100)) 'E-2tR70' cutoffSTR]);
else
...
if applyUnif==1
     print('-dpng', '-r1000', ['BinaryRastaMTSATscan' sprintf('%02i',Frank) 'MT' sprintf('%02i',MTnum) '-' sprintf('%i',cloudythresh) 'g' ...
                               sprintf('%02i',NBcla) 'cl' Nettype PredicPixels trainingfct Part sprintf('%02i',RADSneighbor) 'km' ...
                               filterIWPflag DIVIDER sprintf('%i',divid*10) 'E-1tR70' cutoffSTR ]);
else
     print('-dpng', '-r1000', ['BinaryRastaMTSATscan' sprintf('%02i',Frank) 'MT' sprintf('%02i',MTnum) '-' sprintf('%i',cloudythresh) 'g' sprintf('%02i',NBcla) 'cl' Nettype PredicPixels trainingfct Part sprintf('%02i',RADSneighbor) 'km' filterIWPflag ]); 
end
end
